...
void SCANFunctional::excpbe(double rho, double grad,
...
void SCANFunctional::excpbe_sp(double rho_up, double rho_dn,
...
void SCANFunctional::gcor2(double a, double a1, double b1, double b2, double b3,
